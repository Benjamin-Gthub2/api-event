...
FROM registrations registrations
         ...
         INNER JOIN users beneficiaries_users -- maybe we should rename this table to people
                    ON registrations.user_id = beneficiaries_users.id
         INNER JOIN user_types beneficiaries_user_types
         ...
         INNER JOIN users creator_users
                    ON registrations.user_id = creator_users.id
