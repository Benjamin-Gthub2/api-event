...
type UserRepository interface {
	...
	GetRolesByUser(ctx context.Context, userId string) ([]MerchantRoleByUser, error)
	GetUserPermissionsByRole(ctx context.Context, userId string, roleId string) ([]GetUserPermissionsByRole, error)
	GetGlobalRolesByUser(ctx context.Context, userId string) ([]RolesByUser, error)
	GetPasswordUser(ctx context.Context, tx *sql.Tx, userId string) (*string, error)
	UpdatePasswordUser(ctx context.Context, tx *sql.Tx, body UpdatePasswordBody, userId string) error
	UpdatePasswordUserMain(ctx context.Context, body UpdatePasswordBody, userId string) error
