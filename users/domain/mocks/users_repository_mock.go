...
func (_m *UserRepository) CreateUserMain(ctx context.Context, userId string, personId string, body domain.CreateUserBody) (*string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateUserMain")
	}
...
// GetGlobalRolesByUser provides a mock function with given fields: ctx, userId
func (_m *UserRepository) GetGlobalRolesByUser(ctx context.Context, userId string) ([]domain.RolesByUser, error) {
	ret := _m.Called(ctx, userId)

	if len(ret) == 0 {
		panic("no return value specified for GetGlobalRolesByUser")
	}

	var r0 []domain.RolesByUser
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) ([]domain.RolesByUser, error)); ok {
		return rf(ctx, userId)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) []domain.RolesByUser); ok {
		r0 = rf(ctx, userId)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.RolesByUser)
		}
	}
...
func (_m *UserRepository) GetMerchantsByUser(ctx context.Context, userId string) ([]domain.MerchantByUser, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetMerchantsByUser")
	}
...
// GetPasswordUser provides a mock function with given fields: ctx, tx, userId
func (_m *UserRepository) GetPasswordUser(ctx context.Context, tx *sql.Tx, userId string) (*string, error) {
	ret := _m.Called(ctx, tx, userId)

	if len(ret) == 0 {
		panic("no return value specified for GetPasswordUser")
	}
	...
	if rf, ok := ret.Get(0).(func(context.Context, *sql.Tx, string) *string); ok {
		r0 = rf(ctx, tx, userId)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*string)
...
func (_m *UserRepository) GetRolesByUser(ctx context.Context, userId string) ([]domain.MerchantRoleByUser, error) {
	ret := _m.Called(ctx, userId)
	...
	var r0 []domain.MerchantRoleByUser
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) ([]domain.MerchantRoleByUser, error)); ok {
		return rf(ctx, userId)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) []domain.MerchantRoleByUser); ok {
		r0 = rf(ctx, userId)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.MerchantRoleByUser)
		}
	}
...
func (_m *UserRepository) GetStoresByUser(ctx context.Context, userId string) ([]domain.StoreByUser, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetStoresByUser")
	}
...
// GetUserByPersonId provides a mock function with given fields: ctx, personId
func (_m *UserRepository) GetUserByPersonId(ctx context.Context, personId string) (*domain.User, error) {
	ret := _m.Called(ctx, personId)

	if len(ret) == 0 {
		panic("no return value specified for GetUserByPersonId")
	}
...
// GetUserPermissionsByModule provides a mock function with given fields: ctx, codeModule, permissionId
func (_m *UserRepository) GetUserPermissionsByModule(ctx context.Context, codeModule string, permissionId string) ([]domain.UserPermissions, error) {
	ret := _m.Called(ctx, codeModule, permissionId)

	if len(ret) == 0 {
		panic("no return value specified for GetUserPermissionsByModule")
	}

	var r0 []domain.UserPermissions
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) ([]domain.UserPermissions, error)); ok {
		return rf(ctx, codeModule, permissionId)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) []domain.UserPermissions); ok {
		r0 = rf(ctx, codeModule, permissionId)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.UserPermissions)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string) error); ok {
		r1 = rf(ctx, codeModule, permissionId)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *UserRepository) GetUserPermissionsByRole(ctx context.Context, userId string, roleId string) ([]domain.GetUserPermissionsByRole, error) {
...
// UpdatePasswordUser provides a mock function with given fields: ctx, tx, body, userId
func (_m *UserRepository) UpdatePasswordUser(ctx context.Context, tx *sql.Tx, body domain.UpdatePasswordBody, userId string) error {
	ret := _m.Called(ctx, tx, body, userId)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *sql.Tx, domain.UpdatePasswordBody, string) error); ok {
		r0 = rf(ctx, tx, body, userId)
	} else {
		r0 = ret.Error(0)
	}
...
// UpdatePasswordUserMain provides a mock function with given fields: ctx, body, userId
func (_m *UserRepository) UpdatePasswordUserMain(ctx context.Context, body domain.UpdatePasswordBody, userId string) error {
	ret := _m.Called(ctx, body, userId)

	if len(ret) == 0 {
		panic("no return value specified for UpdatePasswordUserMain")
	}
...
func (_m *UserRepository) UpdatePersonToUser(ctx context.Context, tx *sql.Tx, peopleId string, userId string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdatePersonToUser")
	}
...
func (_m *UserRepository) UpdateUserMain(ctx context.Context, userId string, personId string, body domain.UpdateUserBody) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateUserMain")
	}
...
func (_m *UserRepository) UpdateUserTheme(ctx context.Context, body domain.UpdateUserThemeBody, userId string) error {
	ret := _m.Called(ctx, body, userId)
...
func (_m *UserRepository) ValidateUniquePersonByDocument(ctx context.Context, typeDocumentId string, document string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for ValidateUniquePersonByDocument")
	}
...
func (_m *UserRepository) ValidateUniqueUserExistence(ctx context.Context, tx *sql.Tx, userId string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for ValidateUniqueUserExistence")
	}
...
func (_m *UserRepository) VerifyIfPersonExist(ctx context.Context, personId string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for VerifyIfPersonExist")
	}
...
func (_m *UserRepository) VerifyIfUserExist(ctx context.Context, userId string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for VerifyIfUserExist")
	}
