...
type ViewMenuUser struct {
	...
	//Description: the position of the view menu user
...
type UserMe struct {
	...
	Theme *string `json:"theme" binding:"required" example:"cyan"`
	//Description: date of created
	CreatedAt *time.Time       `json:"created_at" example:"2023-11-10 08:10:00"`
	Person    *PersonByUser    `json:"person"`
...
type Merchant struct {
	...
	Name *string `json:"name" example:"Almacen Central"`
	//Description: the description of the merchant
	Description *string `json:"description" example:"Almacen Central"`
}
...
type MerchantRoleByUser struct {
	//Description: the id of the merchant
	Id string `json:"id" binding:"required" example:"739bbbc9-7e93-11ee-89fd-0242ac110016"`
	//Description: the name of the merchant
	Name string `json:"name" binding:"required" example:"Almacen Central"`
	...
	Stores      []StoreRoleByUser `json:"stores" binding:"required"`
}

type StoreRoleByUser struct {
	//Description: the id of the store
	Id string `json:"id" binding:"required" example:"739bbbc9-7e93-11ee-89fd-0242ac110016"`
	//Description: the name of the store
	Name  string        `json:"name" binding:"required" example:"Almacen Central"`
	Roles []RolesByUser `json:"roles" binding:"required"`
}

type RolesByUser struct {
	//Description: the id of the role
	Id string `json:"role_id" binding:"required" example:"fcdbfacf-8305-11ee-89fd-0242ac110016"`
	//Description: the id of the role
	Name *string `json:"role_name" example:"Jefe de Area Residual"`
	//Description: the description of the role
	Description *string `json:"role_description" example:"Gerencia del conglomerado"`
	//Description: enable of the role
	Enable *bool `json:"role_enable" example:"true"`
	//Description: the date of created of the role
	CreatedAt *time.Time `json:"role_created_at" example:"2023-11-27 19:47:15"`
}

type GetUserPermissionsByRole struct {
	...
	Position    int                  `json:"position" binding:"required" example:"1"`
	Permissions []PermissionByModule `json:"permissions" binding:"required"`
}

type PermissionByModule struct {
...
type GeneralRolesByUser struct {
	Merchants   []MerchantRoleByUser `json:"merchants" binding:"required"`
	GlobalRoles []RolesByUser        `json:"global_roles" binding:"required"`
}

type UpdatePasswordBody struct {
	CurrentPassword string `json:"current_password" binding:"required" example:"old"`
	NewPassword     string `json:"new_password" binding:"required" example:"new"`
}

type UpdateUserThemeBody struct {
	Theme string `json:"theme" binding:"required" example:"black"`
}
