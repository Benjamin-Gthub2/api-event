...
const docTemplateusers = `{
    ...
    "paths": {
        ...
        "/api/v1/core/users/update/password": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpdatePasswordBody"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/core/users/{userId}/merchants/roles": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Success Request",
                        "schema": {
                            "$ref": "#/definitions/rest.rolesByUserResult"
                        }
                    },
                    "500": {
                        "description": "Bad Request",
        ...
        "/api/v1/core/users/{userId}/roles/{userRoleId}/permissions": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/core/users/{userId}/theme": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "description": "Update user theme body",
                        "name": "UpdateUserThemeBody",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpdateUserThemeBody"
                        }
                    },
                    {
                        "type": "string",
    ...
    "definitions": {
        ...
        "domain.GeneralRolesByUser": {
            ...
            "properties": {
                "global_roles": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.RolesByUser"
                    }
                },
                "merchants": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.MerchantRoleByUser"
                    }
                }
            }
        },
        ...
        "domain.MerchantRoleByUser": {
            ...
            "properties": {
                ...
                "stores": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.StoreRoleByUser"
                    }
                }
            }
        },
        ...
        "domain.UserMe": {
            ...
            "properties": {
                ...
                "theme": {
                    "description": "Description: theme of the user",
                    "type": "string",
                    "example": "cyan"
                },
                "username": {
        ...
        "domain.ViewMenuUser": {
            ...
            "properties": {
                ...
                "position": {
                    "description": "Description: the position of the view menu user",
                    "type": "integer",
                    "example": 1
                },
                "url": {
        ...
        "rest.rolesByUserResult": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/domain.GeneralRolesByUser"
                },
                "status": {
                    "type": "integer"
                }
...
// SwaggerInfousers holds exported Swagger Info so clients can modify it
var SwaggerInfousers = &swag.Spec{
	Version:          "",
	Host:             "",
	BasePath:         "",
	Schemes:          []string{},
	Title:            "",
	Description:      "",
	InfoInstanceName: "users",
	SwaggerTemplate:  docTemplateusers,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfousers.InstanceName(), SwaggerInfousers)
}
