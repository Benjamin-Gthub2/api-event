    ...
    "paths": {
        "/api/v1/event/people": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create body of person",
                        "name": "createPersonBody",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.CreatePersonBody"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/event/people/": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "the document type id of the people",
                ...
                "responses": {
                    "200": {
                        "description": "Success Request",
                        "schema": {
                            "$ref": "#/definitions/rest.peopleResult"
                        }
                    },
                    "500": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpdatePersonBody"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "Success Request",
                        "schema": {
                            "$ref": "#/definitions/rest.deletePersonResult"
                        }
                    },
                    "500": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "domain.DocumentType": {
            ...
            "properties": {
                ...
                "description": {
                    "description": "Description: the status of the document type",
                    "type": "string",
        ...
        "domain.User": {
            ...
            "properties": {
                "created_at": {
                    "description": "Description: the date of created of the user",
                    "type": "string",
                    "example": "2023-11-10 08:10:00"
                },
                "id": {
...
// SwaggerInfopeople holds exported Swagger Info so clients can modify it
var SwaggerInfopeople = &swag.Spec{
	Version:          "",
	Host:             "",
	BasePath:         "",
	Schemes:          []string{},
	Title:            "",
	Description:      "",
	InfoInstanceName: "people",
	SwaggerTemplate:  docTemplatepeople,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfopeople.InstanceName(), SwaggerInfopeople)
}
