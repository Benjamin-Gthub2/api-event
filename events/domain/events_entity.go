...
type EventSums struct {
	...
	Name string `json:"name" binding:"required" example:"Event 1"`
	//Description: the quantity of registrations
	TotalRegistrations int `json:"total_registrations" binding:"required" example:"1"`
	//Description: the quantity of payments
	TotalPayments int `json:"total_payments" binding:"required" example:"1"`
	//Description: the quantity of presences
	TotalPresences int            `json:"total_presences" binding:"required" example:"1"`
	WorkshopSums   []WorkshopSums `json:"workshops_sums"`
}
