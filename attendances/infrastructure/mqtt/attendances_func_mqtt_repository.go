/*
 * File: attendances_func_mqtt_repository.go
 * Author: Benjamin
 * Copyright: 2026, Smart Cities Peru.
 * License: MIT
 *
 * Purpose:
 * This file contains the mqtt repository functions for attendances.
 *
...
func (r attendancesMqttRepository) SendNotification(
	ctx context.Context,
	topic string,
	payload string,
) (
