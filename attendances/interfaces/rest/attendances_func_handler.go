...
// @Param event_id query string false "id of event"
// @Param workshop_id query string false "id of workshop"
// @Param beneficiary_id query string false "id of beneficiary"
