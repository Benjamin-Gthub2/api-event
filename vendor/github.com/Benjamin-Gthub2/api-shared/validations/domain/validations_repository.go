...
type ValidationRepository interface {
	RecordExists(ctx context.Context, params RecordExistsParams) (bool, error)
	ValidateExistence(ctx context.Context, params RecordExistsParams) (bool, error)
	ValidateUniqueField(ctx context.Context, params ValidateUniqueFieldParams) (bool, error)
}
